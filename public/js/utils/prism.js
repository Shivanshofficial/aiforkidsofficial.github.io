/* PrismJS 1.23.0
https://prismjs.com/download.html#themes=prism-coy&languages=markup+css+clike+powershell+python&plugins=custom-class+show-language+highlight-keywords+command-line+toolbar+copy-to-clipboard+match-braces */
...
(function () {
	...
	Prism.hooks.add('before-highlight', function (env) {
		...
		// Works only for <strong> wrapped inside <pre> (not inline).
		var pre = env.element.parentElement;
		if (!pre || !/pre/i.test(pre.nodeName) || // Abort only if neither the <pre> nor the <strong> have the class
	...
	Prism.hooks.add('complete', function (env) {
		...
		var pre = env.element.parentElement;
		if (CLASS_PATTERN.test(env.element.className)) { // Remove the class "command-line" from the <strong>
